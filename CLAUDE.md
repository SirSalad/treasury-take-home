...
**YOU ARE IN: `treasury_take_home/polecats/furiosa/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/treasury_take_home/` (rig root) or other directories
...
**Your mail address:** `treasury_take_home/polecats/furiosa`
**Your rig:** treasury_take_home
**Your Witness:** `treasury_take_home/witness`
...
| Ask Witness for help | `gt mail send treasury_take_home/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`treasury_take_home/witness`) when:
...
```bash
gt mail send treasury_take_home/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
