...
export function ReviewChecklist({
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-[1.35fr_1.35fr_110px_30px] gap-0 border-b border-[#e6e8ea] bg-fed-head-bg px-[18px] py-[9px] text-[10.5px] font-bold uppercase tracking-[.5px] text-fed-gray-light">
        <div>Requirement</div>
        <div>On Label</div>
        <div>Result</div>
        <div />
      ...
      {fields.map((field) => {
        ...
        return (
          <button
            ...
            className={`grid w-full grid-cols-[1.35fr_1.35fr_110px_30px] items-center gap-0 border-b border-fed-line-soft px-[18px] py-3 text-left transition-colors last:border-b-0 focus-visible:outline-none ${
              isActive
          ...
          >
            <div className="pr-3">
              <div className="text-[13.5px] font-bold text-fed-ink">{fieldLabel(field.field)}</div>
              <div className="mt-px text-[11.5px] text-fed-gray-light">
                App: {field.expected ?? "—"}
              </div>
            </div>
            <div className="pr-3 text-[13px] font-medium text-fed-slate">
